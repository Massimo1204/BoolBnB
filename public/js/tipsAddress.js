...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _key__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./key */ "./resources/js/key.js");
...
function callApi() {
  var newAdress = address.value.replace(/ /g, "%20");
  var search = 'https://api.tomtom.com/search/2/search/' + newAdress + '.json?countrySet=IT&lat=37.337&lon=-121.89&extendedPostalCodesFor=Str&minFuzzyLevel=1&maxFuzzyLevel=2&view=Unified&relatedPois=off&key=' + _key__WEBPACK_IMPORTED_MODULE_0__["APP_KEYMAPS"] + '&countrySet=Italia';
  ...
  request.send();
  var tips;
  request.onload = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var data, _loop, index;
...
/***/ 1:
/*!*******************************************!*\
  !*** multi ./resources/js/tipsAddress.js ***!
  \*******************************************/
